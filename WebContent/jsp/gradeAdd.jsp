...
<html>
  ...
  <div class="panel-head"><strong><span class="icon-key"></span> 注册讲师等级资料</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="<%=basePath%>gradeServlet?action=add" method="post" >
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="mpass" name="gradeName" size="50" placeholder="请输入讲师名称" />       
        </div>
      </div>      
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="password" class="input w50" name="gradePercent" size="50" placeholder="请输入提成比例"  />         
        </div>
      </div>
      <div class="form-group">
        <div class="label">
