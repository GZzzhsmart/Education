...
public class UploadVedioServlet extends HttpServlet {
	...
	/*文件上传：
	 * 1.要把cos.jar文件拷贝到WEB-INF/lib文件夹
	 * 2.创建上传的jsp页面，页面的表单必须有如下2个属性，并且值是固定的
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String filePath = getServletContext().getRealPath("/") + "vedio";  
        ...
        try{
        	...
        	getServletContext().getRequestDispatcher("/T13/uploadVedio.jsp").forward(request, response);
        	return;
        }
